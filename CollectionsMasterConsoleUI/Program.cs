...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            do
            {
                ...
                numOK = int.TryParse(Console.ReadLine(), out userNum);
            }
            while(numOK == false);
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine("Yes your number is on the list.");
            }
            else
            {
                Console.WriteLine("No, your number is not on the list.");
            }
        }
